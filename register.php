                          ...
                          <div class="contact-page-wrapper style-03">
                            <div class="contact-form contact-bg style-01" style="background-image: url(assets/img/contact-02.png);">
                              <div class="content desktop-center">
                                ...
                                <h6 class="title">Create your account</h6>
                              </div>
                              <form action="#." class="contact-page-form" novalidate="novalidate">
                                  <div class="row">
									  ...
									  <div class="col-md-6 col-sm-12">
                                          <div class="form-group">
                                              <input type="text" name="lname" placeholder="Password*" class="form-control" required="" aria-required="true">
                                          </div>
                                      </div>
                                      <div class="col-md-6 col-sm-12">
                                          <div class="form-group">
                                      ...
                                      <div class="col-md-12 col-sm-12">
                                        <div class="form-group">
                                            <input type="text" name="fname" placeholder="Address" class="form-control" required="" aria-required="true">
                                        </div>
                                      </div>
                                      
                                      <div class="col-md-12">
									  <div class="check-box">
                            <label class="container-box">  Keep me signed in
                                <input type="checkbox" checked="checked">
                                <span class="checkmark"></span>
                            </label>
                        </div>
                                        <div class="btn-wrapper desktop-center">
                                          <a href="#" class="boxed-btn political-btn style-01">CREATE YOUR ACCOUNT<i class="icon-paper-plan"></i></a>
                                        </div>
                                      </div>
									  
									    <div class="col-md-12">
										<div class="form-group text-center">
												<p class="mt-5"style="color: white;">Have an account? <a href="sign-in.php"><strong>Sign in</strong></a>
												</p>
											</div> <span class="text-light-white fs-12 terms" style="color: white;">By creating your Ecom account, you agree to the <a href="sign-in.php" style="color: white;"> Terms of Use </a> and <a href="#" style="color: white;"> Privacy Policy.</a></span>
									  </div>
