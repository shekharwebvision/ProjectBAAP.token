...
<head>
  ...
  <meta http-equiv="X-UA-Compatible" content="ie=edge"/>
  <title>Bhartiya Awakend Azad Party | An Official website</title>
  <!-- favicon -->
    ...
    <nav class="navbar navbar-area style-01 navbar-expand-lg nav-style-02">
      <div class="container nav-container">
		...
		<div class="btn-wrapper">
            <a href="sign-in.php" class="boxed-btn political-btn">login <i class="icon-paper-plan"></i></a>
          </div>
          <!--<div class="btn-wrapper">
            <a href="register.php" class="boxed-btn political-btn">Register<i class="icon-paper-plan"></i></a>
          </div>-->
        </div>
