            ...
            <div class="col-lg-10">
                <div class="volunteer-form">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="fname" placeholder="Full Name*" class="form-control" required="" aria-required="true">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
								 ...
								 <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="text" placeholder="Donation Amount*" class="form-control" required="" aria-required="true">
                                    </div>
                                </div>
								
								 <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" name="text" placeholder="Reference Code*" class="form-control" required="" aria-required="true">
                                    </div>
                                </div>
								 <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" name="text" placeholder="Eth Address*" class="form-control" required="" aria-required="true">
                                    </div>
                                </div>
                    ...
                    <div class="btn-wrapper">
                        <a href="#" class="boxed-btn btn-sanatory volunteer"><i class="fas fa-arrow-right"></i>SUBMIT</a>
                    </div>
                </div>
            </div>
        </div>
